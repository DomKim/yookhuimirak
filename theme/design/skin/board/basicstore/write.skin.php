    ...
    <?php } ?>
				...
				<div id="k_w_bo" style="margin-top: 50px;">
					<table class="k_w_table">
						...
						<tr class="tr_sort">
							<td class='td_sort'>서브메뉴명<b>*</b><span class="sound_only"> 서브메뉴명 </span></td>
							<td ><input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="k_input_sort frm_input full_input required k_input k_input_w100" size="50" maxlength="255" placeholder="서브메뉴명을 입력해주세요."></td>
						</tr>                       
                        <tr class="tr_sort">
                            <td>
						...
						<tr class="tr_sort">
							...
							<? }else{ ?>
								<td class='td_sort'>내용사진 #<?php echo $i+1 ?></td>
							<? } ?>
