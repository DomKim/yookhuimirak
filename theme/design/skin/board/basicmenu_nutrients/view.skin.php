...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>디저트 하위분류</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_4']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>커피 하위분류</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_5']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>신메뉴 선택</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_link1']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>hot</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_link2']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>ice</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_6']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>상품명</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>상품명영문</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_2']), 70); // 글제목 출력 ?></p>
            </div> 
            <div class="bo_v_con_1st_con">
                <p class='bo_v_con_1st'>상품설명</p>  
                <p class='bo_v_con_1st_pr'><?php echo cut_str(get_text($view['wr_content']), 70); // 글제목 출력 ?></p>
            </div>
