...
<div class="vst-view-wrap">
    ...
    <div class="vst-view-head">
        ...
        <div class="vst-view-info">
            ...
            <div class="vst-info-right">
                ...
                <span class="vst-info-item"><a href="#bo_vc" style="text-decoration:none; color:inherit;"><i
    ...
    <section class="vst-view-content">
        ...
        <?php if ($is_signature) { ?>
            <p style="margin-top:50px; color:#888; font-size:13px; border-top:1px dashed #eee; padding-top:20px;">
