    ...
    <div class="vst-view-head">
        ...
        <div class="vst-view-info">
            ...
            <div class="vst-info-right">
                ...
                <span class="vst-info-item"><a href="#bo_vc" class="vst-link-comment"><i class="fa fa-comment-o"></i> <?php echo number_format($view['wr_comment']) ?></a></span>
            </div>
        </div>
    </div>
    ...
    <section class="vst-view-content">
        ...
        <div class="vst-biz-info">
            <div class="vst-biz-row">
                <div class="vst-biz-th">번호</div>
                <div class="vst-biz-td"><?php echo cut_str(get_text($view['wr_1']), 70); ?></div>
            </div>
            <div class="vst-biz-row">
        ...
        <?php if ($is_signature) { ?><p class="vst-signature"><?php echo $signature ?></p><?php } ?>
    </section>
