...
<!--
        <div class="vst-form-group">
            <label for="wr_2" class="vst-label">comming soon</label>
            <input type="checkbox" id="wr_6_checkbox">
            <input type="hidden" name="wr_6" id="wr_6" value="null">
        </div>
-->
...
-->
        ...
        <div class="vst-form-group">
            <label for="wr_2" class="vst-label"><i class="fa fa-circle"></i> 기준월</label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="vst-input"
                placeholder="숫자만 입력">
        </div>

        <div class="vst-form-group">
            <label for="wr_4" class="vst-label"> 매출액</label>
            <input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_4" class="vst-input"
                placeholder="숫자만 입력">
        </div>
