...
<div class="vst-view-wrap">
        ...
        <div class="vst-view-info">
            <div class="vst-info-left">
                <span class="vst-info-item">
                    ...
                    <?php echo $view['name'] ?><?php if ($is_ip_view) {
                           echo "&nbsp;($ip)";
                       } ?>
                </span>
                <span class="vst-info-item">
            ...
            <div class="vst-info-right">
                <span class="vst-info-item"><i class="fa fa-eye"></i>
                    <?php echo number_format($view['wr_hit']) ?></span>
                <span class="vst-info-item"><a href="#bo_vc" class="vst-link-comment"><i
                            class="fa fa-comment-o"></i> <?php echo number_format($view['wr_comment']) ?></a></span>
            </div>
        </div>
    </div>
            ...
            <ul>
                ...
                for ($i = 0; $i < count($view['file']); $i++) {
                    if (isset($view['file'][$i]['source']) && $view['file'][$i]['source'] && !$view['file'][$i]['view']) {
                        ?>
                        <li>
                            <i class="fa fa-download" class="vst-icon-accent"></i>
                            <a href="<?php echo $view['file'][$i]['href']; ?>" class="view_file_download">
                                <strong><?php echo $view['file'][$i]['source'] ?></strong>
                            </a>
                            <span class="vst-file-info">
                                <?php echo $view['file'][$i]['content'] ?> (<?php echo $view['file'][$i]['size'] ?>) |
                                <?php echo $view['file'][$i]['download'] ?>회
                            </span>
                        </li>
                        <?php
                    }
            ...
            <ul>
                ...
                for ($i = 1; $i <= count($view['link']); $i++) {
                    if ($view['link'][$i]) {
                        ?>
                        <li>
                            <i class="fa fa-link" class="vst-icon-accent"></i>
    ...
    <section class="vst-view-content">
        ...
        <div class="vst-biz-info">
            ...
            <div class="vst-biz-row">
                <div class="vst-biz-th">커밍순 여부</div>
                <div class="vst-biz-td"><?php echo cut_str(get_text($view['wr_6']), 70); ?></div>
            </div>
        
            <div class="vst-biz-row">
                <div class="vst-biz-th">매장명</div>
                <div class="vst-biz-td"><?php echo cut_str(get_text($view['wr_subject']), 70); ?></div>
            </div>
            <div class="vst-biz-row">
                <div class="vst-biz-th">기준월</div>
                <div class="vst-biz-td">
                    <?php echo cut_str(get_text($view['wr_2']), 70); ?>
                </div>
            </div>
            <div class="vst-biz-row">
                <div class="vst-biz-th">매출액</div>
        ...
        <?php if ($is_signature) { ?>
            <p class="vst-signature">
                <?php echo $signature ?></p><?php } ?>
    </section>
    ...
    <div id="bo_v_share">
        <?php if ($scrap_href) { ?>
            <a href="<?php echo $scrap_href; ?>" target="_blank" class="vst-btn"
    ...
    <div class="vst-view-btn">
        <div class="vst-btn-wrap">
            ...
            <?php if ($delete_href) { ?><a href="<?php echo $delete_href ?>" class="vst-btn vst-btn-danger"
                    onclick="del(this.href); return false;">삭제</a><?php } ?>
            <?php if ($copy_href) { ?><a href="<?php echo $copy_href ?>" class="vst-btn"
                    onclick="board_move(this.href); return false;">복사</a><?php } ?>
            <?php if ($move_href) { ?><a href="<?php echo $move_href ?>" class="vst-btn"
        ...
        <div class="vst-btn-wrap">
            ...
            <?php if ($write_href) { ?><a href="<?php echo $write_href ?>"
                    class="vst-btn vst-btn-primary">글쓰기</a><?php } ?>
        </div>
    </div>
